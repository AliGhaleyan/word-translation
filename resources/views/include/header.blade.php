<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container">
        <a class="navbar-brand" href="#">B Amooz</a>
        ...
        <div class="collapse navbar-collapse" id="navbarsExample07">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item active">
                    <a class="nav-link" href="{{ route("word.index") }}">Word <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
...
@if($message = session('message'))
    ...
    <div class="container">
        <div class="row mt-3">
            <div class="col-12">
                @if(is_array($message))
                    <div class="alert alert-{{ $message['type'] ?? "info" }}" role="alert">
                        {{ $message['text'] }}
                    </div>
                @else
